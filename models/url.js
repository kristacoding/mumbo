...
const websiteSchema = new Schema({
  ...
  pageSpeedScore: { type: String, required: false},
  ...
  Topurl1: {type: String, required: true},
  Topurl2: {type: String, required: true},
  Topurl3: {type: String, required: true},
  Topurl4: {type: String, required: true},
  Topurl5: {type: String, required: true},
  Topurl6: {type: String, required: true},
  Topurl7: {type: String, required: true},
  Topurl8: {type: String, required: true},
  Topurl9: {type: String, required: true},
  Topurl10: {type: String, required: true},
